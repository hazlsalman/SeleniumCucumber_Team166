...
public class SauceStepdefinitions {
    ...
    public void saucedemo_username_kutusuna_yazar(String direkKullaniciAdi) {

        saucePage.usernameKutusu.sendKeys(direkKullaniciAdi);
    }

    @Then("saucedemo password kutusuna {string} yazar")
    public void saucedemo_password_kutusuna_yazar(String direkPassword) {

        saucePage.passwordKutusu.sendKeys(direkPassword);
